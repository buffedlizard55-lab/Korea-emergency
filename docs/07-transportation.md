...
Sources: Incheon airport [S14], AREX [S15].
...
- **T-money / Cashbee transit card:** rechargeable card for subway + buses;
  buy at convenience stores (GS25, CU, 7-Eleven) or subway kiosks. Tap in/out
  on subways/buses.
- **Subway (Seoul Metro):** extensive, cheap, English signage/announcements.
- **Kakao T / Naver:** Uber-style ride-hailing (Kakao T is the main one; you
...
- AREX to ICN, limousine bus, or taxi. Weekend morning traffic is usually
  lighter than weekday rush, but allow buffer.

## Taxi / directions phrase card
Write these down or save on your phone (show the driver / use Naver Map):
- Hotel name & address in Korean (get from booking confirmation)
- "인천공항" = Incheon Airport
- "서울역" = Seoul Station
- "공항버스 정류장" = airport bus stop
- "얼마예요?" = How much is it?
- "카드 됩니까?" = Do you accept card?
