...
## Traveler Profile (Fill for EACH traveler — do not share secret info on the public card; keep a private version in your bag)

| Field | Traveler 1 (Male) | Traveler 2 (Female) |
|---|---|---|
| Full name (as on passport) | | |
| Passport number (last 4 digits ONLY on card) | **** | **** |
| Date of birth | | |
| Blood type | | |
| Allergies — food | | |
| Allergies — drug / medication | | |
| Allergies — latex / insect / environmental | | |
| Current medications (name / dose / frequency) | | |
| Emergency medication carried (e.g., epinephrine / inhaler / insulin) | | |
| Doctor / primary care name & phone (CA) | | |
| Travel insurance policy # | | |
| Insurance 24/7 claim / emergency line | | |
| Emergency contact in California (name / relationship / phone / email) | | |
...
*This card is for emergency identification only. It does not replace insurance, medical records, or official government ID. Verify all medication names and doses with your doctor before 31 Oct 2026. Update if any health condition changes before departure.*
