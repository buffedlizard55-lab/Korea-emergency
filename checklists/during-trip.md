# During-Trip Checklist & Quick Reference
...
- [ ] Share "arrived safely" message with home contact

## Daily
- [ ] Check AirKorea for fine-dust; wear KF94 if high (05)
- [ ] Carry hotel card/address in Korean + passport copy
- [ ] Keep 2 payment methods in separate places (09)
- [ ] Follow any Emergency Alert texts (treat as drill unless told otherwise) (08)
...
- [ ] Process any tax-refund forms (TTS) before security
- [ ] Declare cash ≥ $10,000 if applicable
- [ ] Confirm return flight + any CSAT-adjacent schedule
